...
int main() {
    ...
    std::vector<int> d10p {00,10,20,30,40,50,60,70,80,90};;
    ...
    std::cout << "d6: " << d4[0] << std::endl;
    std::cout << "d8: " << d4[0] << std::endl;
    std::cout << "d10: " << d4[0] << std::endl;
    std::cout << "d10%: " << d4[0] << std::endl;
    std::cout << "d12: " << d4[0] << std::endl;
    std::cout << "d20: " << d4[0] << std::endl;
